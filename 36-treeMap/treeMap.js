...
Tree.prototype.map = function (callback) {
  ...
  function recursion(tree, forNewTree) {
    if (tree.children.length !== 0) {
      for (var i = 0; i < tree.children.length; i++) {
        forNewTree.children.push(new Tree(callback(tree.children[i].value)))
        if (tree.children[i].children.length !== 0) {
          recursion(tree.children[i], forNewTree.children[i], callback);
        }
      }
    }
  }
  recursion(this, newTree, callback)
  return newTree;
};
...
//   return value * 2;
// })
// console.log(root1.value) // 2
// console.log(root1.children[0].value) // 4
// console.log(root1.children[1].value) // 6
// console.log(root1.children[0].children[1].value) // 10
// console.log(root1.children[1].children[1].value) // 14